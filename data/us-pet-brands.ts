...
export const US_PET_BRANDS: SeedBrand[] = [
  ...
  },
  {
    ...
    owner: "Mars",
    species: "cat",
    lines: ["Perfect Portions", "Bistro", "Meaty Tender Sticks"],
  },
  {
    name: "Iams",
    owner: "Mars",
  ...
  },
  {
    ...
    owner: "Independent",
    species: "both",
    lines: ["Homestead", "Rustic Blend", "Freeze Dried Raw", "Kind Earth", "Ancient Grains"],
  },
  {
  ...
  },
  {
    ...
    owner: "Whitebridge",
    species: "cat",
    lines: ["After Dark", "Grill", "Luau", "Velvet Mousse", "Born Carnivore", "Baby", "Stix"],
  },
  ...
  { name: "Dogswell", owner: "Whitebridge", species: "dog" },
  {
    ...
    owner: "Independent",
    species: "both",
    lines: ["Classic", "Cats in the Kitchen", "TruLuxe", "Dogs in the Kitchen", "Paw Lickin'"],
  },
  ...
  },
  {
    ...
    owner: "Independent",
    species: "both",
    lines: ["FreeStyle", "MedalSeries", "Frontrunner", "Freeze-Dried Raw"],
  },
  {
  ...
  { name: "Frisco", owner: "Chewy", species: "both" },
  {
    ...
    lines: ["Grain Free", "All Life Stages", "Fresh Recipes"],
  },
  ...
  { name: "Well & Good", owner: "Petco", species: "both", aliases: ["well and good"] },
  {
    ...
    owner: "PetSmart",
    species: "both",
    lines: ["Source", "Essentials", "Origins", "Freeze Dried Raw"],
  },
